...
snakemake -s magsearch.snakefile --profile slurm --jobs 32 --restart-times 1
"""

#configfile: "config.yml"
configfile: "config.k31.yml"
...
rule catalog_metagenomes:
  ...
  run:
    ...
    with open("/group/ctbrowngrp/sra_search/metagenomes_source_20220524.csv") as fp:
